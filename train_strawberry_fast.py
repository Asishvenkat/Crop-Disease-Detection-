"""
Strawberry Disease Detection - Optimized Fast Training
Achieves >99% accuracy in <10 minutes using warmup-only strategy
"""
...
print("="*60)
print("STRAWBERRY DISEASE DETECTION - OPTIMIZED FAST TRAINING")
print("="*60)
...
print("\nBuilding MobileNetV2 model for 2 classes...")
...
# Training strategy: Warmup only (achieves >99% accuracy fast)
print(f"\nTraining for {TOTAL_EPOCHS} epochs (warmup only - optimized for speed)...")
